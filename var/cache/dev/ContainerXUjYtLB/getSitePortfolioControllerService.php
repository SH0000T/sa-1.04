 ...
 */
class getSitePortfolioControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\SitePortfolioController' shared autowired service.
     *
     * @return \App\Controller\SitePortfolioController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AbstractController.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'SitePortfolioController.php';

        $container->services['App\\Controller\\SitePortfolioController'] = $instance = new \App\Controller\SitePortfolioController();
        ...
        ]))->withContext('App\\Controller\\SitePortfolioController', $container));
